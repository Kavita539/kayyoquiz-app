...
<div className="result-box">
    <div className="question">
        ...
        <div className="options grid-50-50">
            ...
            <div key={index} className={`result-option ${ selectedOptions[questionIndex]===index ? correctOption===index
                ? "correct-answer" : "wrong-answer" : Number(correctOption)===index ? "correct-answer" : "" }`}>
                {option}
            </div>
            ))}
        </div>
